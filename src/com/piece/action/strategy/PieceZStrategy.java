...
public class PieceZStrategy extends PieceStrategy {
   ...
   /**
	...
	protected boolean deplacerGauchePos2Pos4(ITable theGrille, Piece thePiece) {
		...
		ICell cell1 = theGrille.getCell(indexNumLigPosRefPiece - 1, indexNumeCellPosRefPiece);
		if (cell1.estOccupe()) {
			return false;
		}
		...
		ICell cell3 = theGrille.getCell(indexNumLigPosRefPiece + 1, indexNumeCellPosRefPiece - 1);
		if (cell3.estOccupe()) {
			thePiece.setBloque(true);
			return false;
		}
   ...
   /**
     * Methode permettant de deplacer la pieceZ dans la position 1 et position 3.<br/>
     * 
     * @param theGrille La grille.<br/>
     * @param thePiece La piece.<br/>
	...
	protected boolean deplacerDroitePos2Pos4(ITable theGrille, Piece thePiece) {
		...
		ICell cel2 = theGrille.getCell(indexNumLigPosRefPiece, indexNumeCellPosRefPiece + 2);
		if (cel2.estOccupe()) {
			return false;
		}
