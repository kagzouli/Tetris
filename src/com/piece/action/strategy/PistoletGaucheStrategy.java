...
public class PistoletGaucheStrategy extends PieceStrategy {
	...
	public boolean deplacerDroitePosition4(ITable theGrille, Piece thePiece) {
		...
		ICell cel3 = theGrille.getCell(indexNumLigPosRefPiece +1, indexNumeCellPosRefPiece + 2);
		if (cel3.estOccupe()) {
			return false;
		}
	...
	public boolean rotationPosition1(ITable theGrille, Piece thePiece) {
		...
		ICell cell3 = theGrille.getCell(indexNumLigPosRefPiece + 1, indexNumCellPosRefPiece);
		if (cell3.estOccupe()) {
			return false;
		}
