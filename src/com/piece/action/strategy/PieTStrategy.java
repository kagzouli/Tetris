...
public class PieTStrategy extends PieceStrategy {
	...
	public boolean deplacerDroitePosition4(ITable theGrille, Piece thePiece) {
		...
		ICell cel1 = theGrille.getCell(indexNumLigPosRefPiece, indexNumeCellPosRefPiece + 2);
		if (cel1.estOccupe()) {
			return false;
		}
		
		ICell cel2 = theGrille.getCell(indexNumLigPosRefPiece - 1, indexNumeCellPosRefPiece + 1);
		if (cel2.estOccupe()) {
			return false;
		}
	...
	public boolean deplacerGauchePosition2(ITable theGrille, Piece thePiece) {
		...
		ICell cell3 = theGrille.getCell(indexNumLigPosRefPiece, indexNumeCellPosRefPiece - 2);
		if (cell3.estOccupe()) {
			thePiece.setBloque(true);
			return false;
		}
